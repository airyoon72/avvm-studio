...
(function () {
  ...
  Object.assign(en, {
    ...
    baPreviewTitle: 'CHECK BEFORE + AI AFTER', baPreviewCopy: 'Use the slider to review both moments. Change the direction and create a new AI AFTER concept if you would like another option. The video is made from this pair after payment.', baPreviewPlay: 'PREVIEW TRANSITION ▶'
  });
  ...
  const ko = {
    ...
    baPreviewTitle: 'BEFORE와 AI AFTER 시안 확인', baPreviewCopy: '슬라이더로 두 장면을 확인하세요. 마음에 들지 않으면 바람을 바꾸어 AI AFTER 시안을 다시 만들 수 있습니다. 결제 후 이 두 장면으로 전환 영상을 제작합니다.', baPreviewPlay: '전환 미리보기 ▶'
  };
